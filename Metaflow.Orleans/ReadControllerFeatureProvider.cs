...
{
    public class ReadControllerFeatureProvider : IApplicationFeatureProvider<ControllerFeature>
    {
        private readonly Type _genericControllerType;
        private readonly IEnumerable<Type> _entityTypes;

        public ReadControllerFeatureProvider(Type genericControllerType, IEnumerable<Type> grainTypes)
        {
