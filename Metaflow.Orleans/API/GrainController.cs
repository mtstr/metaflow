...
namespace Metaflow.Orleans
{
    ...
    public abstract class GrainController<TState, TResource> : ControllerBase
    {
        ...
        protected Func<TState, Result, IActionResult> Respond = (state, result) => result.OK ? new OkObjectResult(state) : (IActionResult)new BadRequestObjectResult(new { result.Error, result.Events });
